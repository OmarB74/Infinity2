...
#Region "Manager Variables"
    ...
    Private _displayValor As Label
...
#Region "Manager Properties"
    ...
    ''' property to hold our display label value
    Public Property DisplayValor() As Label
        Get
            Return _displayValor
        End Get
...
#Region "DisplayData"
    ''' <summary>
    ''' Method to display the data to and from the port on the screen
    ''' </summary>
    ''' <remarks></remarks>
    <STAThread()> _
