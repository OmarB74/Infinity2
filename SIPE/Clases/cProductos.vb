...
Public Class cProductos
    ...
    Public Function Obtener_Producto(ByVal strConexion As String) As DataSet
        Dim ds As New DataSet
        Dim sError As String
        Try
            Cnn = New SqlConnection(strConexion)
            cmd = New SqlCommand("spProductosPerfumes", Cnn)
            ...
            da.Fill(ds, "ProductosPerfumes")       'llenar dataset
