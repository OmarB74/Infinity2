...
Public Class cTipoRelleno
    Private Cnn As SqlConnection
    Private cmd As SqlCommand
    Private param As SqlParameter
    Private da As SqlDataAdapter
    Public Function Obtener_TipoRelleno(ByVal strConexion As String) As DataSet
        Dim ds As New DataSet
        Dim sError As String
        Try
            Cnn = New SqlConnection(strConexion)
            cmd = New SqlCommand("spCatalogoTipoRelleno", Cnn)
            ...
            da.Fill(ds, "TipoRelleno")       'llenar dataset
